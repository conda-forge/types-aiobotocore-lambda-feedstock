About types-aiobotocore-lambda-feedstock
========================================
...
Summary: Type annotations for aiobotocore.Lambda 3.9.1 service generated with mypy-boto3-builder
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/types-aiobotocore-lambda-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/types-aiobotocore-lambda-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add types-aiobotocore-lambda
# for installing globally
pixi global install types-aiobotocore-lambda
```
...
It is possible to list all of the versions of `types-aiobotocore-lambda` available on your platform:
...
```
pixi search types-aiobotocore-lambda --channel conda-forge
```
